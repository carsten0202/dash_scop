    ...
    layout = dbc.Container(
        html.Div(
            [
                ...
                dcc.Store(id="color-column-name"),  # holds just the column name for the current color selection
                ...
                dcc.Store(id="shape-column-name"),  # holds just the column name for the current shape selection
