    ...
    layout = dbc.Container(
        html.Div(
            [
                ...
                dcc.Store(
                    id="color-column-name", data=None
                ),  # holds just the column name for the current color selection
                ...
                dcc.Store(
                    id="shape-column-name", data=None
                ),  # holds just the column name for the current shape selection
